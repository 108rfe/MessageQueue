...
/// @li tthread::thread
/// @li tthread::mutex
/// @li tthread::recursivethr_mutex
/// @li tthread::condition_variable
/// @li tthread::lock_guard
/// @li tthread::fastthr_mutex
///
...
namespace tthread {
	...
	public:
...
#else
			pthreadthr_mutex_init(&mHandle, NULL);
#endif
		}
...
#else
			pthreadthr_mutex_destroy(&mHandle);
#endif
		}
		...
		inline bool try_lock()
		{
			...
			return ret;
#else
			return (pthreadthr_mutex_trylock(&mHandle) == 0) ? true : false;
#endif
		}
		...
		inline void unlock()
		{
			...
			LeaveCriticalSection(&mHandle);
#else
			pthreadthr_mutex_unlock(&mHandle);
#endif
		}
	...
	public:
		...
		recursivethr_mutex()
		{
			...
			InitializeCriticalSection(&mHandle);
#else
			pthreadthr_mutexattr_t attr;
			pthreadthr_mutexattr_init(&attr);
			pthreadthr_mutexattr_settype(&attr, PTHREADthr_mutex_RECURSIVE);
			pthreadthr_mutex_init(&mHandle, &attr);
#endif
		}
		...
		_TTHREAD_DISABLE_ASSIGNMENT(recursivethr_mutex)
	...
	public:
		...
		template <class thr_mutexT>
		inline void wait(thr_mutexT &aMutex)
		{
#if defined(_TTHREAD_WIN32_)
